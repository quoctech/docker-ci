...
function branchManager() {
    return {
        ...
        async load() {
            ...
            if (data?.status === 'success') this.branches = data.data;
            this.loading = false;
        },
        ...
        openEdit(b) {
            ...
            this.form = { name: b.name, address: b.address || '', phone: b.phone || '', email: b.email || '' };
            this.showModal = true;
        },
        ...
        async submitForm() {
            ...
            const url  = this.editingId
                ? '/api/school-management/branches/' + this.editingId
                : '/api/school-management/branches';
...
function branchDetail(uuid) {
    return {
        ...
        branchForm: { name: '', address: '', phone: '', email: '' },
...
function roomManager() {
    return {
        ...
        async submitForm() {
            ...
            const body   = new URLSearchParams(this.form);
            const url    = this.editingId
                ? '/api/school-management/rooms/' + this.editingId
                : '/api/school-management/rooms';
            const method = this.editingId ? 'PUT' : 'POST';
